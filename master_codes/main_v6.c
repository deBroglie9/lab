 ...
 ****************************************************************************/
 ...
 static float Position_Kp[DRIVER_NUMBER]={1,1,1,0.7,5,5,1};
         ...
         //控制部分
             ...
             switch (stage){
                 case 0: printf("initialization finished, start to reset the position\n");
                         // scanf("%s",command);
                         stage = 1;
                         Position_Kp[3]=1;Position_Kp[4]=1;Position_Kp[5]=1;
                         for(counter_slave=0;counter_slave<DRIVER_NUMBER;counter_slave++){
                 ...
                 case 1: counter_loop++;
                         ...
                         if((Error[0]<ERROR)&&(Error[1]<ERROR)&&(Error[2]<ERROR)&&(Error[3]<ERROR)&&(Error[4]<ERROR)&&(Error[5]<ERROR)&&(Error[6]<ERROR)&&(counter_loop>5000)){
                 ...
                 case 2: counter_loop++;
                         ...
                         for(counter_slave=0;counter_slave<DRIVER_NUMBER;counter_slave++){
                             Target_Position[counter_slave]=180/3.1415926536*values[7*counter_loop+counter_slave];
                         }
