...
#define ENCODERICE 0x01222222, 0x00020310
...
const static ec_pdo_entry_reg_t domain8_regs[] = {
    ...
    {BusCouplerPos3,ENCODERICE, 0x7020, 0x01, &off_bytes_cm_1[0], &off_bits_cm_1[0]},
    {BusCouplerPos3,ENCODERICE, 0x7020, 0x02, &off_bytes_cm_2[0], &off_bits_cm_2[0]},
    {BusCouplerPos3,ENCODERICE, 0x7030, 0x01, &off_bytes_target_angle[0], &off_bits_target_angle[0]},
    {BusCouplerPos3,ENCODERICE, 0x6000, 0x01, &off_bytes_ssi[0], &off_bits_ssi[0]},
    {BusCouplerPos3,ENCODERICE, 0x6000, 0x02, &off_bytes_ssi1[0], &off_bits_ssi1[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x01, &off_bytes_ain_1[0], &off_bits_ain_1[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x02, &off_bytes_ain_2[0], &off_bits_ain_2[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x03, &off_bytes_ain_3[0], &off_bits_ain_3[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x04, &off_bytes_ain_4[0], &off_bits_ain_4[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x05, &off_bytes_ain_5[0], &off_bits_ain_5[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x06, &off_bytes_ain_6[0], &off_bits_ain_6[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x07, &off_bytes_ain_7[0], &off_bits_ain_7[0]},
    {BusCouplerPos3,ENCODERICE, 0x6010, 0x08, &off_bytes_ain_8[0], &off_bits_ain_8[0]},
    {}
};
...
void cyclic_task()
{
    ...
    {   
        ...
        if(time_diff < RUNNING_TIME){
            ...
            ssi1=EC_READ_S32(domain3_pd + off_bytes_ssi1[0]);
            ssi=EC_READ_S32(domain3_pd + off_bytes_ssi[0]);
            Target_Position=(float *)&ssi1;
            Actual_Position=(float *)&ssi;
...
int main(int argc, char **argv)
{
    ...
    for(counter_domain=0;counter_domain<DOMAIN_NUMBER;counter_domain++){
    if (!(domain_pd[counter_domain] = ecrt_domain_data(domain_pd[counter_domain])))
        {
